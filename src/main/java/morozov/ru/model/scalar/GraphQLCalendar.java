...
public class GraphQLCalendar extends GraphQLScalarType {
    ...
    @Autowired
    public GraphQLCalendar(@Qualifier("time_bean") SimpleDateFormat simpleDateFormat) {
        super("Calendar", "Calendar type", new CalendarCoercing(simpleDateFormat));
    }
}

class CalendarCoercing implements Coercing<Calendar, String> {

    private SimpleDateFormat simpleDateFormat;

    CalendarCoercing(SimpleDateFormat simpleDateFormat) {
